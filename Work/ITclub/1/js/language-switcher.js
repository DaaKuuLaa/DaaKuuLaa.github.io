    ...
    loadTranslations() {
        this.translations = {
            zh: {
                ...
                // Module 5: 对比分析
                'module5.title': '第五部分：对比分析',
                'module5.description': '深入对比不同噪声算法的特点与应用场景',
                'module5.page1.navTitle': '噪声算法分类',
                'module5.page2.navTitle': '柏林噪声 vs 白噪声',
                'module5.page3.navTitle': '柏林噪声 vs Simplex 噪声',
                'module5.page4.navTitle': '应用场景对比',
                ...
                'module5.page2.whiteNoise.feature1': '完全随机，每个点独立',
                'module5.page2.whiteNoise.feature2': '缺乏连续性',
                'module5.page2.whiteNoise.feature3': '像素化外观',
                'module5.page2.whiteNoise.feature4': '计算简单快速',
                'module5.page2.perlinNoise': '柏林噪声',
                'module5.page2.perlinNoise.feature1': '伪随机，连续平滑',
                'module5.page2.perlinNoise.feature2': '自然真实的外观',
                'module5.page2.perlinNoise.feature3': '可控性强',
                'module5.page2.perlinNoise.feature4': '计算复杂度中等',
                'module5.page2.features': '特点',
                'module5.page3.title': '柏林噪声 vs Simplex 噪声',
                'module5.page3.perlinNoise': '柏林噪声',
                'module5.page3.perlinNoise.feature1': '1983 年发明',
                'module5.page3.perlinNoise.feature2': '网格-based 算法',
                'module5.page3.perlinNoise.feature3': '高维性能较差',
                'module5.page3.perlinNoise.feature4': '有方向性伪影',
                'module5.page3.simplexNoise': 'Simplex 噪声',
                'module5.page3.simplexNoise.feature1': '2002 年改进',
                'module5.page3.simplexNoise.feature2': '单纯形-based 算法',
                'module5.page3.simplexNoise.feature3': '高维性能优秀',
                'module5.page3.simplexNoise.feature4': '无方向性伪影',
                'module5.page3.features': '特点',
                'module5.page4.title': '应用场景对比',
                'module5.page4.gameDev': '游戏开发',
                'module5.page4.gameDevDesc': '地形生成、程序化内容',
                'module5.page4.vfx': '电影特效',
                'module5.page4.vfxDesc': '烟雾、火焰、云等自然现象',
                'module5.page4.graphics': '图形设计',
                'module5.page4.graphicsDesc': '纹理生成、艺术效果',
                'module5.page4.audio': '音频合成',
                'module5.page4.audioDesc': '自然音效、背景音乐',
                'module5.page4.vizTitle': '应用场景可视化',
                'module5.page4.perlinNoise': '柏林噪声',
                'module5.page4.simplexNoise': 'Simplex 噪声',
                'module5.page4.fractalNoise': '分形噪声',
                'module5.page4.whiteNoise': '白噪声',
                
                // Module 6: 总结
                'module6.title': '第六部分：总结与展望',
                'module6.description': '回顾核心概念，探索进一步学习的方向',
                'module6.page1.navTitle': '核心概念回顾',
                'module6.page2.navTitle': '结束',
                'module6.page1.title': '核心概念回顾',
                'module6.page1.coreAlgo': '算法核心',
                'module6.page1.coreAlgoDesc': '通过<span class="highlight">伪随机梯度向量</span>和<span class="highlight">平滑插值</span>，在随机性与自然性之间找到平衡',
                'module6.page1.steps': '关键步骤',
                'module6.page1.stepsDesc': '网格划分 → 梯度分配 → 点乘计算 → 平滑插值 → 噪声值计算',
                'module6.page1.idea': '核心思想',
                'module6.page1.ideaDesc': '局部计算，全局连续，通过平滑函数实现自然过渡',
                'module6.page1.value': '算法价值',
                'module6.page1.valueDesc': '柏林噪声不仅是一种技术工具，更是<span class="highlight">从自然中学习</span>的典范，展示了如何用简单规则创造复杂美感',
                'module6.page2.thanks': '谢谢观看',
                'module6.page2.subtitle': '你已经理解了柏林噪声',
                'module6.page2.explore': '继续探索',
                'module6.page2.resources': '学习资源',
            },
            en: {
                // Navigation
                'nav.module1': 'Problem',
                ...
                'module5.page2.whiteNoise.feature1': 'Completely random, each point independent',
                'module5.page2.whiteNoise.feature2': 'Lacks continuity',
                'module5.page2.whiteNoise.feature3': 'Pixelated appearance',
                'module5.page2.whiteNoise.feature4': 'Simple and fast computation',
                'module5.page2.perlinNoise': 'Perlin Noise',
                'module5.page2.perlinNoise.feature1': 'Pseudo-random, smooth and continuous',
                'module5.page2.perlinNoise.feature2': 'Natural and realistic appearance',
                'module5.page2.perlinNoise.feature3': 'Highly controllable',
                'module5.page2.perlinNoise.feature4': 'Medium computational complexity',
                'module5.page2.features': 'Features',
                'module5.page3.title': 'Perlin Noise vs Simplex Noise',
                'module5.page3.perlinNoise': 'Perlin Noise',
                'module5.page3.perlinNoise.feature1': 'Invented in 1983',
                'module5.page3.perlinNoise.feature2': 'Grid-based algorithm',
                'module5.page3.perlinNoise.feature3': 'Poor performance in high dimensions',
                'module5.page3.perlinNoise.feature4': 'Has directional artifacts',
                'module5.page3.simplexNoise': 'Simplex Noise',
                'module5.page3.simplexNoise.feature1': 'Improved in 2002',
                'module5.page3.simplexNoise.feature2': 'Simplex-based algorithm',
                'module5.page3.simplexNoise.feature3': 'Excellent performance in high dimensions',
                'module5.page3.simplexNoise.feature4': 'No directional artifacts',
                'module5.page3.features': 'Features',
                'module5.page4.title': 'Application Scenarios',
                'module5.page4.gameDev': 'Game Development',
                'module5.page4.gameDevDesc': 'Terrain generation, procedural content',
                'module5.page4.vfx': 'Visual Effects',
                'module5.page4.vfxDesc': 'Smoke, fire, clouds and other natural phenomena',
                'module5.page4.graphics': 'Graphic Design',
                'module5.page4.graphicsDesc': 'Texture generation, artistic effects',
                'module5.page4.audio': 'Audio Synthesis',
                'module5.page4.audioDesc': 'Natural sound effects, background music',
                'module5.page4.vizTitle': 'Application Scenarios Visualization',
                'module5.page4.perlinNoise': 'Perlin Noise',
                'module5.page4.simplexNoise': 'Simplex Noise',
                'module5.page4.fractalNoise': 'Fractal Noise',
                'module5.page4.whiteNoise': 'White Noise',
