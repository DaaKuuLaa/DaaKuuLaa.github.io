...
class VisualizationManager {
  ...
  redrawCanvasText() {
    ...
    // 其他模块的 Canvas 文字也需要重绘
    // TODO: 根据需要添加更多 Canvas 重绘调用
  }
...
drawGridToCanvas(canvasId, width = 500, height = 300, gridSize = 40) {
  ...
  drawApplicationScenarios() {
    ...
    ctx.font = 'bold 14px Arial';
    ctx.textAlign = 'center';
    ctx.fillText('游戏开发 - 地形生成', width / 2, 30);
    ...
    ctx.fillStyle = '#000000';
    ctx.fillText('视觉艺术 - 纹理生成', width / 2, sectionHeight + 30);
    ...
    ctx.fillStyle = '#000000';
    ctx.fillText('科学模拟 - 流体动力学', width / 2, sectionHeight * 2 + 30);
  }
